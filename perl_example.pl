...
#'
#' ## Affiliations 
#' - 1: [Laboratory of Computational Biology, EEAD/CSIC, Spain)](http://www.eead.csic.es/compbio)
#' - 2: [Center for Genomic Sciences, UNAM, Mexico)](http://www.ccg.unam.mx/~vinuesa)
#'
#' # Description
#'
